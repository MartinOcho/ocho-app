  ...
  return (
    <div className={cn(className, isMessagesPage && "xl:w-fit")}>
      ...
      >
        ...
        >
          <Home />
          <span className="text-[0.65rem] max-sm:font-thin sm:hidden">{home}</span>
      ...
      >
        ...
        >
          <Compass />
          <span className="text-[0.65rem] max-sm:font-thin">{explore}</span>
        </OchoLink>
      </Button>
      <Button
        variant="ghost"
      ...
      >
        ...
        >
          <Settings2Icon />
          <span className="text-[0.65rem] max-sm:font-thin">{menu}</span>
        </OchoLink>
      </Button>
      <Button
        variant="ghost"
