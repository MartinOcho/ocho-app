  ...
  return (
    <div className={cn(className, isMessagesPage && "xl:w-fit")}>
      ...
      >
        ...
        >
          <Home />
          <span className="text-[0.65rem] max-sm:font-normal sm:hidden">{home}</span>
      ...
      >
        ...
        >
          <Compass />
          <span className="text-[0.65rem] max-sm:font-normal">{explore}</span>
        </OchoLink>
      </Button>
      <Button
        variant="ghost"
      ...
      >
        ...
        >
          <Settings2Icon />
          <span className="text-[0.65rem] max-sm:font-normal">{menu}</span>
        </OchoLink>
      </Button>
      <Button
        variant="ghost"
