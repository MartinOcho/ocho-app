...
export default function AppLogo({
  ...
  return (
    <span className={className}>
      <div
        className={`flex select-none items-center ${size > 80 && `flex-col`} gap-1`}
      >
        {logoEl}
        <span
...
function LogoXmas({ className = "", size = 48 }: AppLogoProps) {
  ...
  return (
    ...
    >
      ...
      <path fill="none" stroke="url(#xmasGradient)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="1.4" d="
	M6.3,11.3c-3.1-3.1-4.6-6.2,0-6.2S9.4,8.2,6.3,11.3s-4.6,6.2,0,6.2S9.4,14.4,6.3,11.3z"/>
<path fill="#FF0000" d="M5.6,3.1c0,0,3.8-3,5.4-2c0.9,0.5,0.7,1.5,1.6,5.3c0.2,0.8-1.3-0.9-1.5-1.5c0,0-0.1,1.9-0.4,2
	C10.1,7.1,5,3.7,5.6,3.1z"/>
<path fill="#FFFFFF" stroke="#00000011" strokeWidth={1} d="M10.8,7.6c0-0.1,0.1-0.2-0.1-0.7c-0.2-0.3-0.4-0.6-0.6-0.7c-0.1-0.1,0.4,0.1,0.3,0.1
